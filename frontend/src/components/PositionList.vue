...
<template>
  ...
  >
    <!-- Card Header -->
    <div class="flex flex-wrap items-center justify-between gap-3 pb-3 mb-3 border-b" style="border-color: var(--border-subtle);">
    ...
    >
      ...
      <p class="text-xs font-mono font-medium">当前无在途持仓 · AI 决策中枢空仓扫描中 (100% 现金流动性安全)</p>
    </div>
