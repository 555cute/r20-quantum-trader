...
<template>
  <!-- 4 Compact Bento Cards: Mobile 2x2 Grid (两行，一行两个), Desktop 1x4 Grid -->
  <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
    
    <!-- Card 1: 主账户总权益 -->
    <div
      class="rounded-xl border p-2.5 sm:p-3.5 flex flex-col justify-between transition-all shadow-xs"
      style="background-color: var(--bg-card); border-color: var(--border-subtle);"
    >
      <div class="flex items-center justify-between pb-1">
        <div class="flex items-center space-x-1 sm:space-x-1.5 text-[11px] sm:text-xs font-mono font-bold" style="color: var(--text-main);">
          <Wallet class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-indigo-400 shrink-0" />
          <span class="truncate">主账户总权益</span>
        </div>
        <span
          class="text-[9px] sm:text-[10px] font-mono px-1 sm:px-1.5 py-0.2 rounded border font-bold shrink-0"
      ...
      <div class="py-0.5">
        <div class="text-lg sm:text-2xl font-black font-mono tracking-tight num-tabular" style="color: var(--text-main);">
          ${{ totalEq }}
        </div>
        <div class="text-[10px] sm:text-[11px] font-mono truncate" style="color: var(--text-muted);">
    ...
    >
      <div class="flex items-center justify-between pb-1">
        <div class="flex items-center space-x-1 sm:space-x-1.5 text-[11px] sm:text-xs font-mono font-bold" style="color: var(--text-main);">
          <TrendingUp class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400 shrink-0" />
          <span class="truncate">基准累计收益</span>
        </div>
        <span
          class="text-[10px] sm:text-[11px] font-mono font-bold text-emerald-400 num-tabular shrink-0"
        >
      ...
      <div class="py-0.5">
        <div
          class="text-lg sm:text-2xl font-black font-mono tracking-tight num-tabular"
      ...
      <div class="text-[9px] sm:text-[10px] font-mono pt-0.5 truncate" style="color: var(--text-faint);">
        策略基线锚定 2026-03
      </div>
    </div>
    ...
    >
      <div class="flex items-center justify-between pb-1">
        <div class="flex items-center space-x-1 sm:space-x-1.5 text-[11px] sm:text-xs font-mono font-bold" style="color: var(--text-main);">
          <Zap class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-amber-400 shrink-0" />
          <span class="truncate">今日已结盈亏</span>
        </div>
        <span
          class="text-[9px] sm:text-[10px] font-mono px-1 sm:px-1.5 py-0.2 rounded border font-bold text-emerald-400 shrink-0"
      ...
      <div class="flex items-center justify-between text-[9px] sm:text-[10px] font-mono pt-0.5" style="color: var(--text-muted);">
    ...
    >
      <div class="flex items-center justify-between pb-1">
        <div class="flex items-center space-x-1 sm:space-x-1.5 text-[11px] sm:text-xs font-mono font-bold" style="color: var(--text-main);">
          <ShieldCheck class="w-3 h-3 sm:w-3.5 sm:h-3.5 text-blue-400 shrink-0" />
          <span class="truncate">当前持仓浮盈</span>
        </div>
        <span
          class="text-[9px] sm:text-[10px] font-mono font-bold text-emerald-400 shrink-0"
        >
          云端保护挂单
        </span>
      </div>
