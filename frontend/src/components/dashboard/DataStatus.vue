...
<template>
  <div class="flex items-center gap-2">
    <span v-if="store.exchangeLabel" class="chip hidden sm:inline-flex" :title="store.exchangeLabel">
      {{ store.exchangeLabel }}
    </span>
    <span v-if="store.data" class="chip hidden lg:inline-flex">BASE</span>
