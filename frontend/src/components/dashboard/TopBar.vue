...
import { Moon, Sun, Eye, BookOpen, LayoutDashboard, Search } from 'lucide-vue-next';
...
const { peekOpen, aboutOpen, cmdkOpen } = useUi();
  ...
  >
    <div class="mx-auto flex h-full max-w-[2048px] items-center gap-3 px-3 sm:px-5">
      ...
      <div class="flex min-w-0 items-center gap-2.5">
        ...
        <span v-if="store.exchangeLabel" class="badge badge-mono hidden shrink-0 lg:inline-flex" :title="store.exchangeLabel">
          {{ store.exchangeLabel }}
        </span>
      </div>
