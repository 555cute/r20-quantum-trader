...
export const adminGroups: { key: string; labelKey: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'admin-security', labelKey: 'nav.admin.security', path: '/admin/security', icon: KeyRound, alias: 'exchange binance okx account symbols 标的池 账户 凭证' },
    ],
  },
  {
    key: 'platform',
    ...
    items: [
      ...
      { key: 'admin-news', labelKey: 'nav.admin.news', path: '/admin/news', icon: Newspaper, alias: 'news sources binance okx 新闻 来源' },
