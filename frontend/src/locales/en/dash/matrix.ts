export const enMatrix = {
  ...
  kpi: {
    ...
    ocoTip: 'Only verified full exchange-side protection counts. Missing, unknown, partial, or canceling is not armed. Binance paired conditional legs are not atomic OCO.',
  ...
  positions: {
    ...
    ocoOk: 'Confirmed',
    ocoMiss: 'Not confirmed',
    ocoPending: 'Pending',
    ocoMissHint: 'Protection is not verified; requested or pending stops are not armed.',
    pairedHint: 'Binance paired SL/TP legs are independent conditionals, not atomic OCO.',
  },
  orders: {
    tab: 'Open orders',
  ...
  chart: {
    ...
    ocoLines: 'Stop / take-profit lines',
    vwap: 'VWAP',
    ma: 'MA',
    boll: 'BOLL',
    vol: 'VOL',
  ...
  matrix: {
    ...
    adxTip: 'Trend strength (ADX). Missing stays --.',
    cmfTip: 'Money-flow direction: positive = net inflow',
    regime: { trendUp: 'Up trend', trendDown: 'Down trend', range: 'Range', chaos: 'Noise' },
    smartTip: 'Account long/short ratio from the selected adapter when published; missing stays --',
