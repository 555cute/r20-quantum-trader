export const enMatrix = {
  ...
  venueAccounts: {
    title: 'Venue Accounts · Isolated Environments',
    envLive: 'Live',
    envDemo: 'Demo',
    envDemoTip: 'Exchange simulated funding environment (Demo/Testnet)',
    envLiveTip: 'Real funds — fully isolated from demo data',
    refresh: 'Refresh',
    equity: 'Equity',
    ...
    stReady: 'Synced',
    stDegraded: 'Partially unknown',
    stUnavailable: 'Unavailable',
    stNotImpl: 'Not implemented',
    stError: 'Fetch failed',
    partialNote: 'Some venues unsynced: shown per venue only — no cross-venue or cross-environment totals',
    envTip: 'Live and demo data stay separate and are never summed; unknown values render as “—”, never 0.',
  },
};
